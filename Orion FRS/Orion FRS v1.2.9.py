# Orion Face Recognition System.   GUI v1.2.9  
...
class Root(Tk):
    ...
    def settings(self):
        ...
        Checkbutton(f, text="Sound Effects", var=sound, anchor="nw", bg="#00aaff", width=25,relief="raised",borderwidth=5).place(x=20,y=10)
        Checkbutton(f, text="Stop Camera if Person Found",var=stop, anchor="nw", bg="#00aaff", width=25,relief="raised",borderwidth=5).place(x=20,y=40)
        Checkbutton(f, text="Show Camera Hud",var=hud, anchor="nw", bg="#00aaff", width=25,relief="raised",borderwidth=5).place(x=20,y=70)
...
window.title("Face Recognition System V 1.2.9")
