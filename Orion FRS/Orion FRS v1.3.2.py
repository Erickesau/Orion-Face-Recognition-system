# Orion Face Recognition System.   GUI v1.3.2 
...
class Root(Tk):
    ...
    def about(self):
        ...
        Label(f, text="Version 1.3.2",bg="#004444",fg="#00ff00").place(x=10,y=60)
    ...
    def multi_files(self):
        def run_on_thread():
            ...
            def recognize(file_list):
                ...
                p = 100 / num
                porcent = 0
                self.message(progressbar=1, bg="orange", text="Loading")
    ...
    def addimage(self):
        ...
        def proces():
            try:
                # crop face with face_crop script
        ...
        def process():
            ...
            if result_path:
                ...
                Minicard(
                    ...
                    output=result_path + "/thumbnail card.png",
                    text_list=[
...
window.title("Face Recognition System V 1.3.2")
